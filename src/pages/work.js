...
export const projects = [
  { slug: 'pyxl', title: 'PYXL',        date: '05/2026',       image: '/assets/projects/project-1.jpg', alt: 'PYXL', objectPosition: 'center 25%',
    ...
    description: 'PYXL is a web experience for anyone interested in looking at their photography through a new lens. Daily themes guide users\' photo submissions and incentivize them to answer a few questions about their image. The site generates a distorted version of their image in several ways based on their responses, creating a warped image that reflects their emotions, perceptions and memory of that moment in time.',
    sections: [
      { label: 'PROBLEM', text: 'Photography apps treat images as static outputs, but memory is fluid and how we perceive moments changes over time. PYXL asks what if users could see their photos transformed to reflect these emotional shifts and changing perceptions of their own experiences.' },
      { label: 'MY ROLE', text: 'Full-stack designer-engineer. I led product design and user research, built the frontend in React, programmed the custom distortion algorithms in the backend, and architected the data layer using Supabase to store and manage user submissions.' },
      { label: 'PROCESS', text: 'I conducted qualitative user research to understand how people relate to and think about their photography. I iterated through multiple concept directions before landing on algorithmic distortion. The monochrome, minimal aesthetic was designed after user testing revealed that color competed with the user-submitted images and that a minimal interface kept focus on the photos themselves. I programmed the distortion engine in the backend to dynamically warp images based on the emotions and perceptions users submitted.' },
      { label: 'RESULTS', text: 'PYXL was exhibited at UIC\'s Year End Show where we showed it off live to dozens of random visitors who got to experience it in real time. The live user testing validated the core concept and visitors understood the idea immediately, becoming emotionally engaged with their warped images.' },
    ],
